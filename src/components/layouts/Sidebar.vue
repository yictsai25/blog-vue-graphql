      ...
      <ul class="space-y-2">
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Beginner</span>
            <span
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Intermediate</span>
            <span
              class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100 dark:bg-primary-200 dark:text-primary-800"
            >
              4
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Advanced</span>
            <span
              class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100 dark:bg-primary-200 dark:text-primary-800"
            >
              4
